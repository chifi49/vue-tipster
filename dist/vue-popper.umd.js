(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-popper"] = factory();
	else
		root["vue-popper"] = factory();
...
/* harmony default export */ var lib_vue_loader_options_vue_poppervue_type_script_lang_js_ = ({
  ...
  methods: {
    setupHandlers: function setupHandlers() {
      if (this.dsDom != null) {
        ...
        this.dsDom.addEventListener('blue', function () {
          me.hide();
        });
    ...
    hide: function hide() {
      ...
      setTimeout(function () {
        _this.popupO.style.visibility = 'hidden';
        _this.popup_display = 'none';
      }, 500);
    },
  ...
  mounted: function mounted() {
    ...
    document.body.appendChild(this.popupO); //console.log(this.popupO);
...
//# sourceMappingURL=vue-popper.umd.js.map